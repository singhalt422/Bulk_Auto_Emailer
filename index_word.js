...
const transporter = nodemailer.createTransport({
  service: 'Outlook365',
  auth: {
    user: 'inclusion.pwd@saarathee.com', // Your email
    pass: 'S&412476630841'       // Your password or app password
  }
});
...
async function sendEmailsSerially(subject, emailAddresses, content, res) {
  ...
  const senderName = "Tarun Singhal";
  const senderEmail = "inclusion.pwd@saarathee.com";
